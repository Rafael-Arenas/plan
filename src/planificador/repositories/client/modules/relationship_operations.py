...
from planificador.repositories.client.interfaces.relationship_interface import (
    IClientRelationshipOperations,
)
...
class RelationshipOperations(IClientRelationshipOperations):
